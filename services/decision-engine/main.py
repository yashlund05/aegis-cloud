...
from services.decision_engine.routes import router as api_router

logger = setup_logging("decision-engine")
...
app = FastAPI(title="Aegis Decision Engine", lifespan=lifespan)
